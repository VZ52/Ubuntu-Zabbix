...
Pet-версия мониторинга, который я разворачивал на работе (сеть медицинских клиник «Тонус»), с доведённым до конца Telegram-алертингом — на проде до него не дошли из-за бюджетного ограничения на прокси.
